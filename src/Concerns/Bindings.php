...
namespace TinyPixel\Base\Concerns;
...
use TinyPixel\Base\Console\Kernel as BaseKernel;
use TinyPixel\Base\Filesystem\Filesystem as BaseFilesystem;
use TinyPixel\Base\Filesystem\FilesystemServiceProvider as BaseFilesystemServiceProvider;
use TinyPixel\Base\Base\BaseServiceProvider;
...
trait Bindings
{
    ...
    public function registerContainerBindings()
    {
        ...
        foreach([
            ...
            'registerConsoleBindings'    => ['artisan', 'console', BaseKernel::class, IlluminateKernel::class],
            'registerEventBindings'      => ['events', EventDispatcher::class],
            'registerFilesBindings'      => ['files', BaseFilesystem::class, IlluminateFilesystem::class],
    ...
    {
        $this->singleton('console', BaseKernel::class);
    }
    ...
    protected function registerFilesystemBindings()
    {
        $this->singleton('filesystem', function () {
            return $this->loadComponent(
                'filesystems',
                BaseFilesystemServiceProvider::class,
                'filesystem'
            );
        });
     ...
     * @return void
     */
    protected function registerLifecycleBindings()
    {
        $this->singleton('lifecycle', function () {
            return new LifecycleServiceProvider();
        });
    }

...
use TinyPixel\Base\Bootstrap\LoadConfiguration;
use TinyPixel\Base\Bootstrap\LoadBindings;
use TinyPixel\Base\Bootstrap\RegisterProviders;
use TinyPixel\Base\Bootstrap\Console;
...
class Bootloader extends RootsBootloader
{
     ...
     *
     * @param string $application_class Base
     * @param string $basePath
     * @uses  \Roots\add_filters
     */
    public function __construct(string $basePath, string $applicationClass = Base::class)
    {
    ...
    {
        return \apply_filters('base/bootstrap', $this->bootstrap);
    }
}
